...
type
  TTipoAcaoBotoes = (taRetornar, taProcessar, taInicio);
...
begin
  CarregarBanco;
  ControleBotoes(taProcessar);
end;

procedure TfrmPrincipal.ActionRetornarExecute(Sender: TObject);
begin
  ControleBotoes(taRetornar);
end;
...
begin
  ...
  if pTipoAcaoBotoes = taProcessar then
  begin
